                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(Tnombres, javax.swing.GroupLayout.DEFAULT_SIZE, 119, Short.MAX_VALUE)
                                    .addComponent(Tmaterno)
                                    .addComponent(btnEliminar)))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addGap(252, 252, 252)
                                .addComponent(Tpaterno, javax.swing.GroupLayout.DEFAULT_SIZE, 11, Short.MAX_VALUE)
...
public void validar(){
    if(codigo_ws.equals("")){
        ...
        libreria libe=new libreria(codigo_ws,ap_ws,am_ws,nom_ws);
        if(libe.i2==1){
            libe.eliminar();
...
public void verificar(){
    if(codigo_ws.equals("")){
        ...
        libreria lib2=new libreria(codigo_ws);
        if(lib2.error==1){
             JOptionPane.showMessageDialog(null,
                "Error, codigo no existe","Validacion de datos",
                JOptionPane.WARNING_MESSAGE);
             Tcodigo.requestFocus();
        }else{
