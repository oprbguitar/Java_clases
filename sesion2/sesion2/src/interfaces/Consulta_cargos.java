...
public class Consulta_cargos extends javax.swing.JDialog {
   ...
   public String clave="hr";
    ...
    public Consulta_cargos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        conectarBD();
        consulta();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Reporte de cargos"));
        ...
        tReporte.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "codigo", "titulo", "salario minimo", "salario maximo"
            }
        ));
...
public void consulta(){
         try {
         rsx  = snx.executeQuery("select job_id, job_title, min_salary, max_salary from jobs");
         int fila=0;
            while (rsx.next()) {                
                tReporte.setValueAt(rsx.getString(1),fila,0);
